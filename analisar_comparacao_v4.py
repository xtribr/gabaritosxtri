#!/usr/bin/env python3
"""
Analisa a comparação visual entre gabarito real e OMR detectado (v4.0)
"""

# Dados da grade 10x9 (90 questões)
# Verde = acerto, Vermelho = erro
grid_data = [
    # Linha 1 (Q1-Q9) - mas são 10 colunas, então Q1-Q10
    ("A", "green"), ("B", "red"), ("D", "red"), ("E", "red"), ("E", "red"),
    ("E", "red"), ("C", "red"), ("C", "red"), ("C", "red"),
    # Linha 2 (Q11-Q20)
    ("D", "red"), ("C", "red"), ("D", "red"), ("C", "red"), ("D", "red"),
    ("C", "red"), ("A", "green"), ("B", "green"), ("C", "red"),
    # Linha 3 (Q21-Q30)
    ("B", "red"), ("A", "red"), ("B", "green"), ("C", "red"), ("A", "red"),
    ("C", "red"), ("A", "green"), ("B", "red"), ("C", "red"),
    # Linha 4 (Q31-Q40)
    ("B", "red"), ("C", "red"), ("B", "red"), ("C", "red"), ("B", "red"),
    ("B", "red"), ("A", "green"), ("C", "red"), ("A", "red"),
    # Linha 5 (Q41-Q50)
    ("C", "red"), ("A", "red"), ("C", "red"), ("A", "red"), ("B", "green"),
    ("C", "red"), ("B", "green"), ("C", "red"), ("A", "red"),
    # Linha 6 (Q51-Q60)
    ("C", "red"), ("B", "red"), ("D", "green"), ("B", "red"), ("C", "red"),
    ("A", "red"), ("B", "green"), ("C", "red"), ("A", "red"),
    # Linha 7 (Q61-Q70)
    ("B", "red"), ("C", "red"), ("A", "red"), ("C", "green"), ("A", "red"),
    ("A", "red"), ("C", "red"), ("C", "red"), ("B", "green"),
    # Linha 8 (Q71-Q80)
    ("B", "green"), ("C", "red"), ("B", "red"), ("C", "red"), ("B", "red"),
    ("C", "red"), ("A", "green"), ("B", "red"), ("C", "red"),
    # Linha 9 (Q81-Q90)
    ("B", "red"), ("D", "red"), ("B", "red"), ("A", "red"), ("A", "red"),
    ("B", "green"), ("B", "green"), ("C", "red"), ("C", "red"),
...
print("=" * 80)
print("📊 ANÁLISE DE COMPARAÇÃO: GABARITO REAL vs OMR DETECTADO (v4.0)")
print("=" * 80)
print()
...
if melhoria_v3 > 0:
    print(f"  ✅ Melhoria vs v3.0: +{melhoria_v3:.1f} pontos percentuais")
elif melhoria_v3 < 0:
    print(f"  ❌ Piora vs v3.0: {melhoria_v3:.1f} pontos percentuais")
else:
    print(f"  ➡️  Sem mudança vs v3.0")
...
if taxa_acerto < 90:
    ...
    print("  4. Verificar se a resolução está correta (1068x1498px)")
    if taxa_acerto < 50:
